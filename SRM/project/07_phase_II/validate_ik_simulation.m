% validate_ik_simulation.m
% Resolves the trajectory using Analytical IK and generates validation plots.
...
for i = 1:length(t)
    ...
    % Direction of tool (pointing from trocar down to target)
    ...
    try
        ...
        % Forward kinematics on solution to compute true pose and errors
...
% Plot 1: RCM Error (styled with dark theme to match CLIK)
...
% Plot 2: 3D Trajectory (styled with dark theme to match CLIK)
