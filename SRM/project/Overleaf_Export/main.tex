...
To guarantee that the robot is physically capable of reaching the targets from above (flange strictly above the trocar, $z_e$ pointing downward), the targets and trocar were placed within the workspace: $c_r = [-0.5; 0.0; 0.4]$, $m_0 = [-0.5; 0.0; 0.3]$, $m_1 = [-0.5; 0.08; 0.28]$, $m_2 = [-0.5; -0.08; 0.28]$, and $m_3 = [-0.55; 0.0; 0.30]$.
