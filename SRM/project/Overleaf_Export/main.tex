...
The error margin at each target point and the average error in between each point (transition intervals) are presented in Table~\ref{tab:target_errors} and Table~\ref{tab:transition_errors}, respectively. The tracking results indicate sub-millimeter precision for the primary trocar RCM constraint, with a maximum transient RCM error of $0.084\text{ mm}$ (during the final hold) and a steady-state error of $0.0108\text{ mm}$ at $t = 30.0\text{ s}$. The tooltip tracking error remains small at static targets (under $0.4\text{ mm}$ at target points $m_0, m_1, m_2$, and settling to $0.0095\text{ mm}$ during steady-state hold), with a maximum transient tracking error of $13.51\text{ mm}$ during the dynamic three-dimensional $m_2 \rightarrow m_3$ transition.
...
$m_1$         & 5  & 0.031682 & 0.381376 \\
$m_2$         & 10 & 0.028543 & 0.310016 \\
$m_3$         & 15 & 0.017113 & 4.686164 \\
$m_4$         & 20 & 0.034973 & 1.063099 \\
$m_5$ (Start) & 25 & 0.068367 & 1.448655 \\
$m_5$ (End)   & 30 & 0.010763 & 0.009452 \\ \bottomrule
\end{tabular}
\end{table}
...
$m_0 \rightarrow m_1$ & $[0, 5]$   & 0.030695 & 0.070445 & 2.953685 & 5.346907 \\
$m_1 \rightarrow m_2$ & $[5, 10]$  & 0.033510 & 0.046225 & 1.026467 & 1.563136 \\
$m_2 \rightarrow m_3$ & $[10, 15]$ & 0.036659 & 0.069747 & 8.200669 & 13.513319 \\
$m_3 \rightarrow m_4$ & $[15, 20]$ & 0.028372 & 0.045869 & 6.243548 & 11.341174 \\
$m_4 \rightarrow m_5$ & $[20, 25]$ & 0.042788 & 0.068367 & 3.103206 & 5.710279 \\
$m_5$ Hold            & $[25, 30]$ & 0.050951 & 0.084123 & 0.236115 & 1.448655 \\ \bottomrule
\end{tabular}
\end{table}
